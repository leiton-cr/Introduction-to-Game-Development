...
function love.load()
    ...
    -- dificulty will affect the visibility field of the paddles making the game harder 
    -- 1. Nigthmare
    -- 2. Hard
    -- 3. Normal
    -- 4. Easy    
    ...
    -- highlighted option on select menus
    highlighted = 0

    -- used to auto serve when is computer turn leaving a small delay in time 
    serveDelay = 1
    delayPass = 0
...
function love.update(dt)
    ...
    if playerMode < 3 then
        ...
        player1.visibilityField = VIRTUAL_WIDTH / dificulty
    ...
    if playerMode == 1 then
        ...
        -- If the ball comes to the player paddle
        player2.visibilityField = VIRTUAL_WIDTH - (VIRTUAL_WIDTH / dificulty) 
...
function love.keypressed(key)
    ...
    elseif key == 'enter' or key == 'return' then
        ...
        elseif gameState == 'serve' then
            ...
            -- dont let serve player when is computer turn
...
function love.draw()
    ...
    elseif gameState == 'selectDificulty' then
        renderDificultySelect()

    elseif gameState == 'selectPlayers' then
        renderPlayerSelect()
    end

    if gameState ~= 'selectDificulty' and gameState ~= 'selectPlayers' then
        displayScore()
